<?php 
include("../../../core.php");
print Website::header(array("title"=>"The Crackme Chall - Easy"));
...
print "<a href=".dirname($_SERVER["PHP_SELF"])."/support_files/02_crackme_easy.exe><img src=img/v.png border=0 width=128><br>";
print "02_crackme_easy.exe</a>";
print "</td></tr>";
print "</table>";
print "<br><br>";
